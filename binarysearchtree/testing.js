...
export function assertNull(condition, testName) {
    if (condition === null) {
        console.log(`✅ PASS: ${testName}`);
    } else {
        console.error(`❌ FAIL: ${testName} (Expected: null, Got: ${condition})`);
    }
}

export function assertNotNull(condition, testName) {
    if (condition !== null) {
        console.log(`✅ PASS: ${testName}`);
    } else {
        console.error(`❌ FAIL: ${testName} (Expected: not null, Got: ${condition})`);
    }
}
